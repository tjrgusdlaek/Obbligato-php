...
$sql = "INSERT INTO `Chatting`(`Receiver`,`Sender`,`Message`,`Date`,`Chatting_index`,`Location_chatting`,`Sender_name`,`Sender_profile_Image`) VALUES('$get_Writer','$get_Applier','$get_message','$get_Time','$Chatting_index','1','$User_name','$User_image')";
